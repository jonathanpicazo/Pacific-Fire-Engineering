...
import { MdQuestionMark, MdQuestionAnswer } from 'react-icons/md';
...
export default function Page() {
  return (
    <main>
      ...
      <div>
        {qaArray.map((qa) => (
          <div key={qa.id} className="mt-5">
            <div className="flex items-center gap-4 font-bold">
              <div>
                <MdQuestionMark size={30} />
              </div>
              <p>{qa.question}</p>
            </div>
            <div className="ml-10 mt-5 flex items-center justify-start gap-4">
