      ...
      <div className={clsx(layoutContainerClassNames)}>
        ...
        <div className="flex flex-col gap-4">
          <p>
            ...
            with today&apos;s complex Fire and Building Codes while exceeding
            our client&apos;s expectations.
          </p>
          <p>
            We have registered professional engineers on staff with experience
            in the public and private sector. Our experience includes fire
            protection design for residential occupancies, retail centers,
            hotels, casinos, warehouses, cold storage facilities, high-rise
            structures, as well as high pile storage and hazardous materials
            code compliance. We will explain in layman&apos;s terms the complex
            codes that affect your particular situation and provide a clear and
            purposeful solution in the most cost effective manner.
          </p>
          <p>
